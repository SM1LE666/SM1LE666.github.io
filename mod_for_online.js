...
(function () {
  ...
  var currentFanserialsHost = decodeSecret(
    [
      89, 69, 64, 69, 67, 14, 26, 26, 93, 73, 87, 80, 90, 70, 85, 70, 92, 84,
      92, 30, 95, 84, 64,
    ],
    atob("RnVja0Zhbg==")
  );
  ...
  function checkDebug() {
    ...
    decodeSecret([
      85, 77, 93, 87, 89, 71, 87, 30, 86, 89, 88, 88, 88, 81, 12, 70, 66, 80,
      68, 89, 80, 24, 67, 68, 13, 92, 88, 90, 68, 88, 69, 92, 82, 24, 83, 90,
    ])
      .split(";")
      .forEach(function (s) {
  ...
  function isDebug2() {
    return (
      decodeSecret([86, 81, 81, 71, 83]) === "debug" ||
      decodeSecret([92, 85, 91, 65, 84]) === "debug"
    );
  }
  ...
  function fanserialsHost() {
    return (
      ...
      decodeSecret(
        [
          89, 69, 64, 69, 67, 14, 26, 26, 86, 81, 95, 66, 81, 71, 89, 85, 89,
          27, 83, 83,
        ],
        atob("RnVja0Zhbg==")
      )
  ...
  function filmixUserAgent() {
    // Return a generic user agent instead of the specific one
    return "";
  }
  ...
  function vcdnToken() {
    return (
      ...
      (isDebug()
        ? decodeSecret([
            81, 103, 70, 70, 92, 114, 65, 103, 1, 1, 78, 72, 124, 110, 83, 115,
            126, 13, 114, 13, 102, 80, 83, 2, 112, 120, 127, 122, 2, 121, 98,
            100,
          ])
        : decodeSecret(
            [
              0, 10, 1, 126, 69, 15, 11, 114, 119, 11, 77, 94, 89, 126, 82, 93,
              110, 106, 72, 77, 101, 102, 2, 90, 107, 83, 88, 79, 113, 91, 3, 5,
            ],
            atob("RnVja0x1bWV4")
          ))
    );
  ...
  function setMyIp(ip) {
    // Empty implementation to prevent tracking
    return;
  }

  function getMyIp() {
    // Return empty string instead of actual IP
    return "";
  }
  ...
  function proxy(name) {
    ...
    if (isDebug()) {
      proxy_apn =
        (window.location.protocol === "https:" ? "https://" : "http://") +
        decodeSecret([
          64, 90, 72, 90, 92, 91, 87, 87, 23, 83, 81, 65, 90, 91, 78, 24, 83,
          65, 24,
        ]);
      proxy_secret = decodeSecret([
        95, 64, 69, 70, 71, 13, 25, 31, 88, 71, 90, 28, 91, 86, 2, 3, 6, 23, 92,
        91, 72, 83, 86, 25, 87, 64, 73, 24,
      ]);
    ...
    if (name === "filmix_abuse")
      return window.location.protocol === "https:"
        ? "https://cors.apn.monster/"
        : "http://cors.cfhttp.top/";
  ...
  function lumex(component, _object) {
    ...
    function lumex_search(api, callback, error) {
      ...
      network["native"](
        component.proxyLink(api, prox, prox_enc_cookie),
        success_check,
        error_check,
        false,
        {
    ...
    function getStreamM3U(element, call, error, file) {
      ...
      network["native"](
        component.proxyStream(hls_file, "lumex"),
        function (str) {
        ...
        function (a, c) {
          if (file != hls_file) {
            ...
            network.timeout(5000);
            network["native"](
              component.proxyStream(file, "lumex"),
              function (str) {
    ...
    function getStream(element, call, error) {
      ...
      network["native"](
        component.proxyLink(url, prox, prox_enc2),
        function (json) {
  ...
  function lumex2(component, _object) {
    ...
    var api_suffix = "/" + encodeURIComponent(btoa(""));
    var cub_id = encodeURIComponent(btoa("none"));
    var filter_items = {};
    var choice = {
      season: 0,
      voice: 0,
    ...
    this.search = function (_object, kinopoisk_id, data) {
      ...
      if (data && data[0] && data[0].content_type && data[0].id) {
        ...
        src +=
          "searchId/mod/" +
          encodeURIComponent(_imdb_id) +
          "/" +
          encodeURIComponent(_kp_id);
      }
        ...
        function (json) {
          if (json && json.content_type && json.id && json.plgs) {
            var src2 =
              embed +
              "finds/" +
              encodeURIComponent(json.plgs) +
              "/" +
              encodeURIComponent(json.id) +
              "/" +
              encodeURIComponent(json.content_type.replace(/_/g, "-"));
            lumex_api(
              src2 + api_suffix,
              function (json) {
    ...
    function getStream(element, call, error) {
      ...
      component.checkMyIp(function () {
        ...
        var api =
          ...
          object.movie.id +
          "/" +
          encodeURIComponent(element.media.playlist) +
          "/" +
          cub_id +
          api_suffix;
        ...
        //  api,
        // "title=" + encodeURIComponent(object.movie.title)
        //);
        lumex_api(
          api,
          function (json) {
  ...
  function rezka2(component, _object) {
    ...
    this.search = function (_object, kinopoisk_id, data) {
      ...
      var query_more = function query_more(query, page, data, callback) {
        ...
        network.timeout(10000);
        network["native"](
          component.proxyLink(url, prox, prox_enc, prox_enc),
          function (str) {
            str = (str || "").replace(/\n/g, "");
            checkErrorForm(str);
            var links = str.match(
  ...
  function kinobase(component, _object) {
    ...
    var decrypt = Utils.decodeSecret([
      21, 65, 66, 83, 20, 68, 66, 66, 80, 84, 64, 19, 13, 20, 31, 80, 69, 87,
      84, 64, 88, 89, 90, 31, 69, 83, 75, 94, 68, 69, 7, 24, 23, 69, 83, 75, 94,
      68, 69, 4, 24, 23, 69, 68, 75, 27, 20, 97, 122, 117, 110, 115, 98, 102,
      99, 109, 97, 115, 24, 23, 112, 121, 117, 114, 107, 101, 111, 100, 114, 26,
      16, 76, 68, 81, 67, 26, 20, 65, 89, 84, 16, 76, 20, 71, 87, 70, 23, 68,
      85, 74, 23, 9, 17, 109, 105, 12, 22, 70, 88, 69, 20, 65, 90, 85, 78, 83,
      66, 25, 10, 20, 95, 67, 88, 91, 13, 16, 79, 86, 70, 17, 82, 91, 84, 67,
      93, 92, 89, 64, 17, 11, 20, 31, 88, 85, 78, 23, 112, 126, 123, 100, 86,
      68, 67, 92, 69, 29, 31, 70, 85, 69, 69, 85, 127, 69, 91, 92, 101, 64, 69,
      95, 94, 94, 31, 22, 13, 94, 81, 86, 82, 14, 5, 24, 92, 84, 87, 80, 9, 10,
      82, 86, 83, 77, 15, 10, 27, 85, 89, 84, 64, 9, 22, 29, 22, 22, 67, 83, 72,
      77, 24, 92, 69, 91, 88, 21, 31, 11, 25, 65, 85, 67, 22, 68, 86, 67, 67,
      92, 104, 64, 88, 91, 81, 23, 11, 16, 9, 12, 20, 71, 87, 70, 23, 80, 102,
      86, 94, 80, 17, 11, 20, 81, 67, 94, 90, 67, 93, 94, 88, 28, 30, 77, 77, 2,
      20, 65, 13, 20, 74, 31, 11, 25, 71, 85, 67, 87, 89, 68, 24, 64, 85, 86,
      77, 84, 68, 20, 10, 22, 64, 85, 86, 77, 84, 68, 15, 23, 68, 85, 77, 66,
      70, 95, 22, 68, 86, 68, 81, 84, 68, 15, 17, 75, 29, 25, 85, 81, 85, 91,
      28, 74, 75, 24,
    ]);
      ...
      if (is_playlist) {
        ...
        if (
          ...
          playlist =
            extract[choice.season].playlist || extract[choice.season].folder;
          season = parseInt(
            extract[choice.season].title || extract[choice.season].comment || ""
          );
      ...
      network[net_method](
        ...
        function (a, c) {
          if (
            ...
            network.timeout(10000);
            network[net_method](
              component.proxyLink(embed2 + api, prox, prox_enc),
              function (str) {
                if (callback) callback(str || "");
              },
              function (a, c) {
    ...
    function filtred() {
      ...
      if (extract.playlist) {
        ...
        extract.qualityByWidth &&
          Lampa.Arrays.getKeys(extract.qualityByWidth).forEach(function (
            resolution
          ) {
        ...
        var audio_infos = extract.source.audio.names.map(function (
          name,
          index
        ) {
          var order =
  ...
  function cdnmovies(component, _object) {
    ...
    var host = Utils.decodeSecret([
      95, 64, 69, 70, 71, 13, 25, 31, 79, 94, 80, 84, 89, 92, 83, 24, 95, 87,
      91, 93, 95, 83,
    ]);
    var ref = host + "/";
    var user_agent =
    ...
    function parseSubs(str) {
      ...
      var subtitles = component.parsePlaylist(str).map(function (item) {
        ...
        return {
          label: item.label,
          url: component.processSubs(
            component.proxyLink(link, prox_stream, "")
          ),
        };
      });
      return subtitles.length ? subtitles : false;
    ...
    this.search = function (_object, kinopoisk_id, data) {
      ...
      var apiSearch = function apiSearch(abuse) {
        ...
        url = abuse
          ...
          : component.proxyLink(url, prox, prox_enc, "enc2");
        network.clear();
        network.timeout(10000);
        network["native"](
          url,
      ...
      network["native"](
        ...
        function (str) {
          ...
          if (player) {
            ...
            network.timeout(10000);
            network["native"](
              component.proxyLink(player[1], prox, prox_enc2),
              function (str) {
                parse(str);
              },
              function (a, c) {
  ...
  function fancdn2(component, _object) {
    ...
    this.search = function (_object, kinopoisk_id) {
      ...
      var error = component.empty.bind(component);
      var api =
        (+kinopoisk_id ? "kinopoisk=" : "imdb_id=") +
        encodeURIComponent(kinopoisk_id);
      fancdn_api_search(
        api,
        function (str) {
  ...
  function videoseed(component, _object) {
    ...
    var suffix = Utils.decodeSecret(
      [
        69, 91, 92, 84, 89, 5, 87, 5, 87, 9, 8, 5, 1, 3, 7, 12, 87, 11, 9, 3, 1,
        2, 84, 8, 86, 12, 85, 3, 5, 9, 7, 4, 83, 80, 14, 10, 80, 5,
      ],
      atob("U2Vla1Rva2Vu")
    );
    var headers = Lampa.Platform.is("android")
    ...
    this.search = function (_object, kinopoisk_id) {
      ...
      network.timeout(10000);
      network["native"](
        component.proxyLink(api, prox, prox_enc, "enc2"),
        function (json) {
    ...
    function decode(data) {
      ...
      var trashList = [
        "qVNP035fDl3hd05QZUkkYsRYC1glOVERZU0YGNvpepEFC",
        "g8c71IUSaroqb636BTt7hlKNMA4oR718nyDbbiMm6PCEh",
        "3dNupT1rfIIIQgFh5Xhbk2i18Rfe4GN8Dq6IxL5saG9Y1",
        "hxFNhEtJfd1WeZkns6d7DLvJ8vv8E88XenAtZ4UvDJeBV",
        "7r3aw2Eat03AiCGA260OBqg7qYmtPbG7aFY8T2b1GSNuL",
      ];
      var x = data.substring(2);
      trashList.forEach(function (trash) {
        x = x.replace("|||" + enc(trash), "");
      ...
      items.forEach(function (element) {
        ...
        var hash_file = Lampa.Utils.hash(
          element.season
            ...
            : object.movie.original_title + "videoseed"
        );
        element.timeline = view;
        item.append(Lampa.Timeline.render(view));
  ...
  function vibix(component, _object) {
    ...
    var auth = Utils.decodeSecret(
      [
        115, 83, 89, 70, 84, 74, 17, 6, 3, 8, 6, 74, 124, 108, 117, 91, 100, 97,
        0, 8, 102, 4, 0, 95, 70, 127, 121, 4, 114, 117, 1, 89, 126, 94, 114, 12,
        96, 83, 89, 102, 126, 0, 115, 96, 67, 73, 68, 7, 124, 69, 67, 5, 1, 87,
        3, 93, 4, 82, 11, 85,
      ],
      atob("VmliaXhBdXRo")
    );
  ...
  function alloha(component, _object) {
    ...
    var user_agent = Utils.decodeSecret([
      122, 91, 75, 95, 88, 91, 87, 31, 12, 25, 4, 17, 30, 99, 94, 88, 84, 86,
      64, 71, 17, 120, 96, 23, 7, 0, 23, 7, 15, 17, 97, 93, 89, 0, 4, 2, 23, 76,
      7, 2, 29, 23, 119, 64, 73, 91, 81, 102, 83, 86, 124, 95, 68, 22, 2, 7, 6,
      24, 7, 1, 22, 24, 114, 127, 96, 124, 122, 24, 23, 90, 89, 82, 82, 20, 118,
      83, 87, 92, 89, 25, 25, 116, 92, 67, 89, 89, 82, 25, 1, 10, 0, 26, 1, 24,
      4, 25, 6, 16, 106, 86, 82, 80, 68, 93, 24, 3, 3, 14, 25, 7, 7,
    ]);
    var headers2 = Lampa.Platform.is("android")
      ? {
          "User-Agent": user_agent,
    ...
    var token = Utils.decodeSecret([
      83, 7, 0, 1, 0, 3, 7, 3, 12, 14, 81, 4, 6, 1, 84, 5, 4, 10, 84, 6, 1, 0,
      7, 82, 82, 83, 0, 0, 81, 6,
    ]);
    var embed = "https://api.apbugall.org/?token=" + token;
    var decrypt = Utils.decodeSecret([
      31, 82, 68, 88, 87, 67, 95, 95, 87, 31, 71, 69, 68, 24, 23, 67, 66, 85,
      27, 20, 69, 89, 95, 82, 88, 28, 25, 86, 66, 0, 31, 79, 23, 64, 81, 75, 23,
      81, 73, 66, 70, 86, 85, 68, 25, 10, 20, 74, 75, 15, 23, 64, 81, 75, 23,
      92, 94, 69, 64, 23, 11, 16, 76, 69, 88, 31, 91, 85, 67, 85, 88, 17, 24,
      106, 25, 94, 64, 67, 70, 67, 6, 13, 104, 30, 106, 27, 108, 104, 108, 22,
      106, 31, 24, 106, 27, 24, 31, 11, 25, 94, 82, 17, 30, 92, 88, 69, 68, 16,
      92, 89, 64, 24, 22, 31, 23, 17, 31, 30, 30, 15, 17, 83, 76, 67, 68, 81,
      90, 67, 26, 66, 66, 70, 82, 87, 93, 102, 95, 81, 80, 82, 81, 69, 69, 16,
      4, 23, 120, 80, 91, 68, 86, 24, 96, 85, 86, 64, 87, 89, 70, 90, 24, 89,
      74, 31, 19, 80, 88, 80, 69, 89, 89, 93, 16, 29, 17, 9, 20, 76, 22, 23,
      118, 69, 93, 86, 95, 90, 16, 12, 16, 81, 88, 71, 69, 109, 5, 106, 26, 16,
      30, 101, 81, 87, 83, 70, 82, 68, 23, 3, 23, 92, 94, 69, 64, 108, 7, 109,
      25, 28, 20, 22, 25, 19, 27, 22, 23, 108, 68, 81, 67, 27, 117, 80, 83, 94,
      77, 16, 14, 17, 67, 71, 82, 68, 111, 88, 80, 81, 95, 66, 20, 74, 22, 10,
      25, 76, 73, 10, 22, 73, 23, 68, 85, 77, 66, 70, 95, 22, 81, 79, 66, 66,
      88, 84, 64, 10, 22, 73, 30, 24, 83, 88, 91, 88, 25, 77, 73, 27,
    ]);
    var filter_items = {};
    var choice = {
      season: 0,
    ...
    function alloha_api_search(api, callback, error) {
      ...
      network.timeout(10000);
      network["native"](
        component.proxyLink(embed + "&" + api, prox, "", "enc2"),
        function (json) {
          if (callback) callback(json);
        },
        function (a, c) {
    ...
    function getPage(data) {
      ...
      network.timeout(20000);
      network["native"](
        component.proxyLink(data.iframe, prox2, prox2_enc, "enc2"),
        function (str) {
    ...
    function getStream(element, call, error) {
      ...
      network["native"](
        component.proxyLink(
          extract.domain + "api/movie/" + element.media.id,
          prox2,
          extract.prox2,
          "enc2"
        ),
    ...
    this.search = function (_object, kinopoisk_id, data) {
      ...
      var display = function display(links) {
        if (links && links.length && links.forEach) {
          ...
          var items = links.map(function (l) {
            ...
            var year_link = $(
              '.card__desc span:contains("Год выпуска:")+a',
              article
            );
      ...
      var query_search = function query_search(query, data, callback) {
        ...
        network["native"](
          ...
          function (str) {
            str = (str || "").replace(/\n/g, "");
            var links = str.match(
              /<article class="card d-flex">.*?<\/article>/g
            );
            if (links && links.length) data = data.concat(links);
      ...
      if (
        ...
        query_search(
          ...
          function (data) {
            if (data && data.length && data.forEach) display(data);
            else if (object.movie.imdb_id && +object.movie.kinopoisk_id) {
              query_search(
    ...
    function getPage(card) {
      ...
      network["native"](
        ...
        function (str) {
          str = (str || "").replace(/\n/g, "");
          var player = str.match(
            /<div [^>]*id="visearch"[^>]*>[^<]*<iframe data-src="((https?:\/\/embed\.new\.video[^"\/]*)\/[^"]*)"/
          );
          ...
          if (!player_link) {
            ...
            try {
              json =
                find &&
                (0, eval)(
                  '"use strict"; (function(){ return ' + find[1] + "; })();"
                );
            } catch (e) {}
    ...
    function parse(str) {
      ...
      try {
        json =
          find &&
          (0, eval)(
            '"use strict"; (function(){ var preroll = [], pauseroll = [], midroll = []; return ' +
              find[1] +
              "; })();"
          );
      } catch (e) {}
      ...
      if (json && json.file) {
        ...
        items.forEach(function (data) {
          if (data.folder) {
            ...
            if (str_s) data.season = parseInt(str_s[2]);
            else data.season = season_count;
            ...
            data.folder.forEach(function (ep) {
              ...
              if (str_e) ep.episode = parseInt(str_e[2]);
              else ep.episode = episode_count;
            });
  ...
  function kinopub(component, _object) {
    ...
    var token = Utils.decodeSecret([
      67, 95, 84, 2, 68, 91, 64, 68, 13, 80, 80, 84, 0, 12, 67, 66, 0, 14, 81,
      95, 92, 70, 65, 93, 15, 92, 87, 64, 6, 70, 7, 2,
    ]);
    var server = "ru";
    var hls_type = "hls";
  ...
  function component(object) {
    ...
    this.isDebug3 = function () {
      ...
      Utils.decodeSecret(
        [
          65, 68, 92, 74, 91, 84, 25, 65, 65, 15, 93, 87, 88, 73, 95, 70, 95,
          83, 28, 87, 82, 13, 87, 64, 90, 84, 90, 70, 83, 26, 94, 88, 89, 80,
          88, 80,
        ],
        atob("cHJpc21pc2hl")
      )
    ...
    var collapsBlocked =
      (!startsWith(window.location.protocol, "http") ||
        window.location.hostname === "lampa.mx") &&
      disable_dbg;
    var all_sources = [
      {
        name: "lumex",
    ...
    this.vcdn_api_search = function (api, data, callback, error) {
      ...
      network["native"](
        this.proxyLink(url + api, prox, "", "enc2"),
        function (json) {
                  ...
                  item
                    ...
                    .forEach(function (voice_item) {
                      if (endsWith(voice_item, ";"))
                        voice_item = voice_item.substring(
                          0,
                          voice_item.length - 1
                        );
  ...
  if (Lampa.Storage.get("online_mod_proxy_reset", "") != 6) {
    if (
      ["collaps", "collaps-dash"].indexOf(
        Lampa.Storage.get("online_mod_balanser", "") + ""
      ) !== -1
    ) {
  ...
  function checkCurrentFanserialsHost(onComplite) {
    ...
    network.timeout(10000);
    network["native"](
      Utils.proxyLink(url, prox, prox_enc),
      function (json) {
  ...
  var button =
    '<div class="card__search selector view--online_mod" data-subtitle="online_mod ' +
    mod_version +
    '">\n    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" version="1.1" width="256" height="256" x="0" y="0" viewBox="0 0 244 260" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">\n    <g xmlns="http://www.w3.org/2000/svg">\n        <path d="M242,88v170H10V88h41l-38,38h37.1l38-38h38.4l-38,38h38.4l38-38h38.3l-38,38H204L242,88L242,88z M228.9,2l8,37.7l0,0 L191.2,10L228.9,2z M160.6,56l-45.8-29.7l38-8.1l45.8,29.7L160.6,56z M84.5,72.1L38.8,42.4l38-8.1l45.8,29.7L84.5,72.1z M10,88 L2,50.2L47.8,80L10,88z" fill="currentColor"/>\n    </g></svg>\n\n    <span>SM1LE</span>\n    </div>';
    ...
    network["native"](
      ...
      function (json) {
        ...
        if (cookie) {
          ...
          network.timeout(8000);
          network["native"](
            Utils.proxyLink(host + "/", prox, prox_enc2),
            function (str) {
              var json =
                typeof str === "string"
              ...
              if (verify_form) {
                ...
                if (verify_cookie) {
                  ...
                  network.timeout(8000);
                  network["native"](
                    Utils.proxyLink(host + "/", prox, prox_enc3),
                    function (str) {
                      var json =
                        typeof str === "string"
                          ? Lampa.Arrays.decodeJson(str, {})
